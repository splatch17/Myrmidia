...
Au dernier round (17) : les menus prennent un **habillage de MMORPG** (cadres dorés, portrait de la reine, jauge circulaire), et **le passage de la chambre vers le hall est enfin dégagé**. Rappel : la cadence de test est ON (attentes ÷8) — `P` puis `5` la coupe. Travail en cours : [tickets `P1-prochain-round`](https://github.com/splatch17/Myrmidia/issues?q=is%3Aopen+label%3AP1-prochain-round). Comment on travaille : [`CONTRIBUTING.md`](CONTRIBUTING.md).
...
| Prototype | Lien |
|---|---|
| Le jeu (Three.js/Vite, `game/`) | **[splatch17.github.io/Myrmidia](https://splatch17.github.io/Myrmidia/)** — republié par la CI à chaque poussée sur `preview`. État détaillé et défauts connus : [PROGRESS.md](PROGRESS.md) |
| Ancien prototype (fichier HTML unique) | [tester](https://raw.githack.com/splatch17/Myrmidia/main/design/prototypes/sortie-fourmiliere.html) — conservé comme référence |
