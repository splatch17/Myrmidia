...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function zo(){return new Pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:qa(),fragmentShader:`
		...
		`,blending:bn,depthTest:!1,depthWrite:!1})}function Ho(){return new Pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qa(),fragmentShader:`
...
`].filter(Wi).join(`
`)),a=Ca(a),a=Zo(a,e),a=jo(a,e),o=Ca(o),o=Zo(o,e),o=jo(o,e),a=Jo(a),o=Jo(o),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
